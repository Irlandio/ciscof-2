   ...
   {?>
    ...
    ?>       
                ...
                if($dataInicial <= $l->dataFin && $dataFinal >= $l->dataFin)
                   {
					...
					{						 
						...
						case 5:	if($dataInicial > $_SESSION['DATA_FIM_BR518'])
                                {
                                    $cdiNome = "CDI NOVAS DE PAZ I"; $cidadeNome = "ABREU E LIMA"; $caixaNome = '0214';
                                }else  
                                {   $cdiNome = "CDI NOVAS DE PAZ II"; $cidadeNome = "PAULISTA";  $caixaNome = '0518';} break;  
                    ...
                    {	
                            if($pPr->id_saida == $l->id_fin){ $bR = " - ".$pPr->documento; }
                        }
                       if($l->num_Doc_Fiscal == "RECIBO" || $l->num_Doc_Fiscal == "S/N") {$docFiscal = " ";} else $docFiscal = " - ".$l->num_Doc_Fiscal;
						...
						echo '<td  heigth="100" bgcolor="#dbdaf7"  colspan="2" > ' .$historico.' </td>
                        <td bgcolor="#dbdaf7" >'.$sede.'</td>';
                        if($ent == 0) 
          ...
          //PRESENTES PAGOS NO MÊS      >>>>>WHERE SUBSTRING(n_beneficiario,1,6) LIKE "'.$contN.'"  and valor_pendente < 1  
                        ...
                        switch ($conta) 
					{	
						case 1:	$contN = "000"; $contNanex = $contN; $cidadde = "Abreu e Lima"; $cdi = "1";     $cdiNome = "NOVAS DE PAZ"; $cidadeNome = "ABREU E LIMA"; $caixaNome = '000'; break; 
						case 2:	$contN = "000"; $contNanex = $contN;  $cidadde = "Abreu e Lima"; $cdi = "000";     $cdiNome = "NOVAS DE PAZ"; $cidadeNome = "ABREU E LIMA"; $caixaNome = '000'; break; 
						case 3:	$contN = "000"; $contNanex = $contN;  $cidadde = "Abreu e Lima"; $cdi = "000";     $cdiNome = "NOVAS DE PAZ"; $cidadeNome = "ABREU E LIMA"; $caixaNome = '000'; break; 
						case 4:	if($dataInicial > $_SESSION['DATA_FIM_BR518'])
                                {
                                    $contN = 'BR0214'; $contNanex = 'BR0518'; $cidadde = "Abreu e Lima"; $cdi = "000";     $cdiNome = "CDI NOVAS DE PAZ I e ANEXO 01"; $cidadeNome = "ABREU E LIMA"; $caixaNome = '0214';
                                }else  
                                {   $contN = "BR0214"; $cidadde = "Abreu e Lima"; $cdi = "000";     $cdiNome = "CDI NOVAS DE PAZ I"; $cidadeNome = "ABREU E LIMA"; $caixaNome = '0214';}
                                 break; 
						case 5:	if($dataInicial > $_SESSION['DATA_FIM_BR518'])
                                {
                                    $contN = 'BR0214'; $contNanex = 'BR0518';  $cidadde = "Abreu e Lima"; $cdi = "000";     $cdiNome = "CDI NOVAS DE PAZ I e ANEXO 01"; $cidadeNome = "ABREU E LIMA"; $caixaNome = '0214';
                                ...
                                {   $contN = "BR0214"; $cidadde = "Abreu e Lima"; $cdi = "000";     $cdiNome = "CDI NOVAS DE PAZ I"; $cidadeNome = "ABREU E LIMA"; $caixaNome = '0214';}
                                 break;   
						case 6:	$contN = "BR0542"; $contNanex = $contN;  $cidadde = "Bezerros";     $cdi = "3";     $cdiNome = "CDI NOVAS DE PAZ III"; $cidadeNome = "BEZERROS"; $caixaNome = '0542';  break;  
						case 7:	$contN = "BR0549"; $contNanex = $contN;  $cidadde = "Catende";      $cdi = "4";     $cdiNome = "CDI NOVAS DE PAZ IV"; $cidadeNome = "CATENDE";  $caixaNome = '0549'; break;
						case 8:	$contN = "BR0579"; $contNanex = $contN;  $cidadde = "Jurema";       $cdi = "5";     $cdiNome = "CDI NOVAS DE PAZ V"; $cidadeNome = "JUREMA";  $caixaNome = '0579'; break;  
                        case 9:	$contN = "000"; $contNanex = $contN;  $cidadde = "Abreu e Lima";       $cdi = "000";     $cdiNome = "NOVAS DE PAZ"; $cidadeNome = "JUREMA";  $caixaNome = '000'; break;  
                        case 10:	$contN = "000"; $contNanex = $contN;  $cidadde = "Abreu e Lima";       $cdi = "000";     $cdiNome = "NOVAS DE PAZ"; $cidadeNome = "JUREMA";  $caixaNome = '000'; break;  
            ...
            if (!$presentes_pagos ) 
                ...
                { 
							...
							echo '<table  border=1 cellspacing=0 bgcolor="white"  width="80%">';
							...
							echo ' </tr>';
							echo '<tr rowspan="2" bgcolor="Gainsboro" style="font-size:70%"><th width="5%" rowspan="2"> Registro</th>';	
							echo '<th width="10%" >DATA</th>';	
							echo '<th width="10%" >NÚMERO DA CRIANÇA</th>';	
							echo '<th width="30%" >NOME DA CRIANÇA</th>';	
							echo '<th width="12%">MÊS/ANO DA LISTAGEM</th>';	
							echo '<th width="8%">NÚMERO DO PROTOCOLO</th>';	
							echo '<th width="10%">VALOR RECEBIDO (ENTRADAS)</th>';	
							echo '<th width="10%">VALOR PAGO (SAÍDAS)</th>';	
							echo '<th width="10%" >SALDO</th></tr>';	
							echo '</thead>';
							echo '<tbody >';														
							echo '<tr>';
                   ...
                   foreach ($presentes_pagos as $pP) 
                    ...
                    if(substr($pP->documento,-11,6) == $contN || (substr($pP->documento,-11,6) == $contNanex))
                    {
                        ...
                        if($pP->n_protocolo == $n_protoc_Ant || $inicio == 1)
                        {
                            ...
                            if($valor_sai_Ant == 0) $cor = "#F7F8E0"; else $cor = "yellow";
                                ...
                                <td><strong>'.date('d/m/y', strtotime($data_pres_Ant)) .'</td>';
                                $html .=    '<td >'.$n_benef_Ant .'</td> <td>'.$nome_benef_Ant .'</td>';
                                $html .=    '<td>'.$mes_extenso_Ant.' -- '.$anoE_Ant.'</td>';
                                $html .=    '<td>'.$n_protoc_Ant.'</td>';
                                ...
                                <td><strong>'.date('d/m/y', strtotime($data_pres_Ant)).'</td>';
                                echo '<td>'.$n_benef_Ant.'</td> <td>'.$nome_benef_Ant.'</td>';
                                echo '<td>'.$mes_extenso_Ant.' -'.$anoE_Ant.'</td>';
                                echo '<td>'.$n_protoc_Ant.'</td>';
                ...
                { 
                   ...
                   foreach ($presentes_pagos as $pP) 
                    ...
                    if($dataInicial <= $pP->data_presente)
                        if((substr($pP->documento,-11,6) == $contN ))
                    {
                          //$data_Ch= implode('/',array_reverse(explode('-',$pP->dataFin )));
                        $val_Ch= number_format($pP->valor_entrada , 2, ',', '.');
                        $valor_pendente= number_format($pP->valor_pendente , 2, ',', '.');
                        ...
                        if($pP->valor_saida == 0) $cor = "#F7F8E0"; else $cor = "Yellow";
                            ...
                            $html .=    '<td align="right">'.$pP->documento .'</td> <td>'.$pP->nome_beneficiario .'</td>';
                            ...
                            <td><strong>'.$pP->data_presente .'</td>';
                            echo '<td align="right">'.$pP->documento .'</td> <td>'.$pP->nome_beneficiario .'</td>';
