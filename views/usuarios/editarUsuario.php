                                ...
                                <select name="permissoes_Geral" id="permissoes_Geral">
                                    <?php foreach ($permissoesID as $p) {
                                        if(!is_numeric($p->nome) ){
                                            if($p->idPermissao == $result->permissoes_Geral){ $selected = 'selected';}else{$selected = '';}
                                                           ...
                                                           <?php
                                                            ...
                                                            foreach ($tiposPermissoes as $tp) {
                                                                if($tp->tipo == 2){
                                                                    ...
                                                                    if($pode == 1)
                                                                    {
                                                                        if(isset($apermissoes[$campo])){ if($apermissoes[$campo] == 1){echo 'checked';}}
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($tiposPermissoes as $tp) {
                                                            ...
                                                            }else 
                                                            {
                                                                ...
                                                                if($pode == 1)
                                                                {
                                                                    if($apermissoes[$campo] == 1){echo 'checked';}
                                                                    ?> 
