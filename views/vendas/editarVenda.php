                            ...
                            Pertence aos 70% </label>                                           
                                    ...
                                    <div class="span5">         
                                        ...
                                        <div class="span5">
                                            ...
                                            <select id="conta" name="conta">
                                                <?php
                                                if($conta != 5) $nomeConta = $result->nome_caixa; else $nomeConta = "BR214(Anexo)";
                                                ?>
                                ...
                                <div class="span5" >
                                            ...
                                            <p class="Historico">
                                                ...
                                                <input class="span12"  name ="razaoSoc" type="text"  value="<?php echo $result->historico ?>"  maxlength=60><font color=red> *</font>

                                            </p>
                                         
                                            <p class="descri">
                                                <label for="descri">Descrição</label>
                                                <input class="span12"  name ="descri" type="text"  value="<?php echo $result->finDescricao ?>"  maxlength=100><font color=red> *</font>
                                            </p> 
