	                                            ...
	                                            <td style="width: 50%; padding-left: 0"><?php
	                                                ...
	                                                <ul>
	                                                    <li>
	                                                        ...
	                                                        <span>Conta:</span>
	                                                        <label for="caixa">
	                                                            <h5><?php echo $result_A->nome_caixa . ' - ' . $result_A->tipo_Conta ?></h5>
	                                                        </label>

	                                                        <span> Código Compassion:</span><br />
	                                                        <label for="codComp">
	                                                            <h5><?php echo $result_A->cod_compassion . " | " . $descri_Comp ?></h5>
	                                                        </label>

	                                                        <span>Código Associação: </span><br />
	                                                        <label for="codAss">
	                                                            <h5><?php echo $result_A->cod_assoc . " | " . $descri_Asso ?></h5>
	                                                        </label>

	                                                        <span>Número do Documento Bancário: </span><br />
	                                                        <label for="numBanc">
	                                                            <h5><?php echo $result_A->num_Doc_Banco ?> </h5>
	                                                        </label>

	                                                        <span>Número do Documento Fiscal:</span><br />
	                                                        <label for="numeroDocFiscal">
	                                                            <h5><?php echo $result_A->num_Doc_Fiscal ?></h5>
	                                                        </label>

	                                                        <span>Razão social:</span> <br />
	                                                        <label for="hist">
	                                                            <h5><?php echo $result_A->historico ?></h5>
	                                                        </label>

	                                                        <span>Descricao:</span><br />
	                                                        <label for="descri">
	                                                            <h5> <?php echo $result_A->descricao ?></h5>
	                                                        </label>
	                                            ...
	                                            <td style="width: 50%; padding-left: 0">
	                                                <ul>
	                                                    <li>
	                                                        ...
	                                                        <label for="data">
	                                                            <h5> <?php echo date('d/m/Y', strtotime($result_A->dataFin)) ?></h5>
	                                                        </label>

	                                                        <span>Forma de saida:</span><br />
	                                                        <label for="pagam">
	                                                            <h5><?php echo $result_A->tipo_Pag; ?></h5>
	                                                        </label>

	                                                        <span>Valor:</span>
	                                                        <label for="valor">
	                                                            <h5> <?php echo  number_format($result_A->valorFin, 2, ',', '.') ?></h5>
	                                                        </label>

	                                                        <?php if ($result_A->ent_Sai == 0) $e_S = 'Saída';
                                                            else  $e_S = 'Entrada'; ?>
	                                                        <label for="numeroDocFiscal">
	                                                            <h5>Lançamento de <?php echo $e_S; ?></h5>
	                                                        </label>
	                                                        <?php
                                                            ...
                                                            foreach ($result_caixas as $caixa) {
                                                                if ($caixa->id_caixa == $result_A->conta_Destino) {
                                                                    $cDestinoNome = $caixa->nome_caixa;
                                                                    if ($result_A->dataFin > $_SESSION['DATA_FIM_BR518'] && $caixa->id_caixa == 5)
                                                                        $cDestinoNome = 'BR-214-Anexo-01';
                                                                }
                                                            }
                                                    ...
                                                    if ($_POST['oP_Exc'] ==  "presentes") { ?>
                                                            ...
                                                            if (isset($presentesE)) { ?>
                                                                ...
                                                                ?>
	                                                                    <label for="Lançamento">
	                                                                        <h5> <?php echo $presExc->id_presente . ' protocolo ' . $presExc->n_protocolo . ' Data ' . $presExc->data_presente . '.' ?></h5>
	                                                                    </label>
	                                                                    <?php
                                                                        ...
                                                                        ?>
	                                                                        <form action="<?php echo current_url(); ?>" method="post">
	                                                                            ...
	                                                                            <input type="hidden" id="idLanc" name="idLanc" value="<?php echo $idpresExc; ?>" />
	                                                                            <label for="Lançamento">
	                                                                                <h5> <?php echo $presExc->id_presente . ' protocolo ' . $presExc->n_protocolo . ' Data ' . $presExc->data_presente . '. ' ?>
	                                                                                    <button class="btn btn-danger">Excluir antes<i class="icon-remove icon-white" title="Excluir lançamento"></i></button>
	                                                                                </h5>
	                                                                            </label>
	                                                                        </form>
	                                                        <?php
...
//****** FORM de Pesquisa para filtro -->
	                                ...
	                                <table class="table table-bordered ">
	                                    <thead>
	                                        <tr style="backgroud-color: #2D335B">
	                                            ...
	                                            <th>
	                                                <H5>Doc (Banc/Fiscal)</H5>
	                                            </th>
	                                            <th width="15%">
	                                                <H5>Histórico | Descrição detalhada </H5>
	                                            </th>
	                                            <th>
	                                                <H5>Valor (R$)</H5>
	                                            </th>
	                                            <th width="<?= $lColunaAlteracoes ?>">
	                                                <H5>Alterações</H5>
	                                            </th>
	                                            <th></th>
	                                    ...
	                                    <tbody>
                                            ...
                                            foreach ($results as $r) {
                                                ...
                                                $caixaNome = $r->nome_caixa;
                                                if ($r->dataFin > $_SESSION['DATA_FIM_BR518'] && $r->conta == 4)
                                                    $caixaNome = 'BR-214-(Sede)';
                                                if ($r->dataFin > $_SESSION['DATA_FIM_BR518'] && $r->conta == 5)
                                                    $caixaNome = 'BR-214-(Anexo-01)';

                                                $aneX = 0;
                                                $cor = '#CDB380';
                                                foreach ($anexos as $a) {
                                                    if ($a->fin_id == $r->id_fin) {
                                                        $cor = '#8A9B0F';
                                                        $aneX = 1;
                                                    }
                                                }
                                                ...
                                                if ($usuario->conta_Usuario == 99) {
                                                    ...
                                                    if ($this->permission->checkPermission($this->session->userdata('permissao'), $permissAddConta)) {
                                                        ...
                                                        if ($r->cod_compassion == "III-III") $cod_compassi = '--- ';
                                                        else  $cod_compassi = $r->cod_compassion;
                                ...
                                <td><font color="#570cbe">' . $r->num_Doc_Banco . '</font><br><font color="#10840b">' . $r->num_Doc_Fiscal . '</font> </td>';
                                                        $limite = 100;
                                                        if (strlen($r->historico) > $limite) $hist = substr($r->historico, 0, $limite) . '(...) ';
                                                        else  $hist = $r->historico . ' ';
                                                        if (strlen($r->descricao) > $limite) $desc = substr($r->descricao, 0, $limite) . '(...)';
                                                        else  $desc = $r->descricao;
