...
//				var_dump($_POST);
  ...
  session_start();
                    ...
                    if($contt != '')
                    {
                        if($_POST['conta'] == 5 && $_POST['tipoES'] == 1 && $_POST['tipCont'] != 'Suporte') $conta = 4; else $conta = $_POST['conta'];
                           ...
                           if($tipoES == ( 1))
                            {
                             ...
                             <input name ="qtd_presentes"  type="hidden" value="<?php echo $qtd_presentes ?>" />
                                ...
                                <?php
                                    ...
                                    ?>
                                    <p>
                                        <label><font color=red>A lista contém Beneficiários do BR214 e Anexo</font></label>
                                    </p>
                                <?php }?>
                                    <table>
