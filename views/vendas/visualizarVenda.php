                                    ...
                                    <td style="width: 50%; padding-left: 0">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span>Conta:</span>
                                                <label for="nome_caixa">
                                                    <h5><?php echo $result->nome_caixa . ' - ' . $result->tipo_Conta ?></h5>
                                                </label>

                                                <span> Código Compassion:</span><br />
                                                <label for="cod_compassion">
                                                    <h5><?php echo $result->cod_compassion . " | " . $descri_Comp . " | " . $area_Comp ?></h5>
                                                </label>

                                                <span>Código Associação: </span><br />
                                                <label for="cod_assoc">
                                                    <h5><?php echo $result->cod_assoc . " | " . $descri_Asso ?></h5>
                                                </label>

                                                <span>Número do Documento Bancário: </span><br />
                                                <label for="num_Doc_Banco">
                                                    <h5><?php echo $result->num_Doc_Banco ?> </h5>
                                                </label>

                                                <span>Número do Documento Fiscal:</span><br />
                                                <label for="num_Doc_Fiscal">
                                                    <h5><?php echo $result->num_Doc_Fiscal ?></h5>
                                                </label>

                                                <span>Razão social:</span> <br />
                                                <label for="historico">
                                                    <h5><?php echo $result->historico ?></h5>
                                                </label>
                                    ...
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                ...
                                                <label for="dataFin">
                                                    <h5> <?php echo date('d/m/Y', strtotime($result->dataFin)) ?></h5>
                                                </label>

                                                <span>Forma de saida:</span><br />
                                                <label for="numeroDocFiscal">
                                                    <h5><?php echo $result->tipo_Pag; ?></h5>
                                                </label>

                                                <span>Valor do evento:</span>
                                                <label for="valorFin">
                                                    <h5> <?php echo  number_format($result->valorFin, 2, ',', '.') ?></h5>
                                                </label>
                                                <?php if ($result->ent_Sai == '1') $e_S = 'Entrada';
                                                else $e_S = 'Saída'; ?>
                                                ...
                                                if (($result->conta_Destino) == null) $cDestinoNome = "A mesma";
                                                    ...
                                                    switch ($result->conta_Destino) {
                                                        case 1:
                                                            $cDestinoNome = "IEADALPE - 1444-3";
                                                            break;
                                                        case 2:
                                                            $cDestinoNome = "22360-3";
                                                            break;
                                                        case 3:
                                                            $cDestinoNome = "ILPI";
                                                            break;
                                                        ...
                                                        case 8:
                                                            ...
                                                            break;
                                                        case 9:
                                                            $cDestinoNome = "BB 28965-5";
                                                            break;
                                                        case 10:
                                                            $cDestinoNome = "CEF 1948-4";
                                                            break;
                                                    }
                                                }
                                                ?>
